# Smoke Test — GLM-4.5-Air

Runs `math_short / protocol A / 1 run` (15 turns) against GLM-4.5-Air.
...
Copy to `smoketest_glm.py`, set `API_KEY`, run:

```bash
python3 smoketest_glm.py
```

Output: `output/smoketest_glm.csv`
...
out_path = OUTPUT_DIR / "smoketest_glm.csv"
